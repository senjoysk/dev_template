...
case "$TECH_STACK" in
    node-typescript|node-javascript|react)
        ...
        copy_file "$TEMPLATE_DIR/stage2/node-typescript/scripts/code-review/error-handling-duplication-check.sh" "scripts/code-review/error-handling-duplication-check.sh"
        copy_file "$TEMPLATE_DIR/stage2/node-typescript/scripts/code-review/layer-separation-check.sh" "scripts/code-review/layer-separation-check.sh"
        copy_file "$TEMPLATE_DIR/stage2/node-typescript/scripts/code-review/todo-comment-check.sh" "scripts/code-review/todo-comment-check.sh"
    ...
    python)
        ...
        copy_file "$TEMPLATE_DIR/stage2/python/scripts/code-review/todo-comment-check.sh" "scripts/code-review/todo-comment-check.sh"
